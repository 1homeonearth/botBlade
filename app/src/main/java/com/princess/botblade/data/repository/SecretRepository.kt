...
import com.princess.botblade.data.model.SecretCreateRequest  // line 11: executes this statement as part of this file's behavior
import com.princess.botblade.data.model.SecretSummary  // line 12: executes this statement as part of this file's behavior
...
class SecretRepository(  // line 17: executes this statement as part of this file's behavior
    ...
    suspend fun listSecrets(): ApiResult<List<SecretSummary>> = apiCall { apiClient.listSecrets() }  // line 20: executes this statement as part of this file's behavior
    suspend fun createSecret(request: SecretCreateRequest): ApiResult<SecretSummary> = apiCall { apiClient.createSecret(request) }  // line 21: executes this statement as part of this file's behavior
    suspend fun rotateSecret(secretId: String, value: String): ApiResult<SecretSummary> = apiCall { apiClient.rotateSecret(secretId, value) }  // line 22: executes this statement as part of this file's behavior
    suspend fun deleteSecret(secretId: String): ApiResult<Unit> = apiCall { apiClient.deleteSecret(secretId) }  // line 23: executes this statement as part of this file's behavior
    ...
    private fun disconnectedMessage(throwable: Throwable): String = when (throwable) {  // line 32: executes this statement as part of this file's behavior
        ...
        else -> throwable.message ?: "Unexpected secret error."  // line 34: executes this statement as part of this file's behavior
