...
class RoyalScepterApiClient(
    ...
    fun getProject(projectId: String): BotProject =
        request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}", method = "GET").toProjectResponse()
    ...
    fun updateProject(projectId: String, request: ProjectUpdateRequest): BotProject {
        ...
        return request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}", method = "PATCH", requestBody = payload).toProjectResponse()
    }

    @Throws(IOException::class)
    fun archiveProject(projectId: String): BotProject =
        request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/archive", method = "POST", requestBody = "{}").toProjectResponse()

    @Throws(IOException::class)
    fun cloneProject(projectId: String): BotProject =
        request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/clone", method = "POST", requestBody = "{}").toProjectResponse()

    @Throws(IOException::class)
    fun listCommands(projectId: String): List<BotCommand> {
        val body = request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/commands", method = "GET")
    ...
    fun createCommand(projectId: String, command: CommandCreateRequest): BotCommand =
        request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/commands", method = "POST", requestBody = command.toCommandPayload()).toCommandResponse()

    @Throws(IOException::class)
    fun updateCommand(projectId: String, commandId: String, command: CommandCreateRequest): BotCommand =
        request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/commands/${UrlEncoding.pathSegment(commandId)}", method = "PATCH", requestBody = command.toCommandPayload()).toCommandResponse()

    @Throws(IOException::class)
    fun deleteCommand(projectId: String, commandId: String) {
        request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/commands/${UrlEncoding.pathSegment(commandId)}", method = "DELETE")
    }
    ...
    fun linkGitHubRepo(projectId: String, request: GitHubLinkRepoRequest): BotProject {
        val payload = JSONObject()
            ...
            .toString()
        return request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/github/create-repo", method = "POST", requestBody = payload).toProjectResponse()
    }

    @Throws(IOException::class)
    fun pushGitHub(projectId: String): String =
        request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/github/push", method = "POST", requestBody = "{}")

    @Throws(IOException::class)
    fun createGitHubWorkflow(projectId: String): GitHubWorkflowResponse {
        val json = requireNotNull(request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/github/create-workflow", method = "POST", requestBody = "{}").asJsonOrNull()) { "Invalid workflow response." }
    ...
    fun generateProject(projectId: String): List<ProjectFileSummary> {
        val body = request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/generate", method = "POST", requestBody = "{}")
    ...
    fun listProjectFiles(projectId: String): List<ProjectFileSummary> {
        val body = request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/files", method = "GET")
    ...
    fun getProjectFile(projectId: String, filePath: String): ProjectFileContent {
        val body = request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/files/${UrlEncoding.filePath(filePath)}", method = "GET")
    ...
    fun saveProjectFile(projectId: String, filePath: String, content: String): ProjectFileContent {
        ...
        val body = request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/files/${UrlEncoding.filePath(filePath)}", method = "PUT", requestBody = payload)
        return requireNotNull(body.asJsonOrNull()) { "Invalid file response." }.toProjectFileContent()
    }
    ...
    fun rotateSecret(secretId: String, value: String): SecretSummary {
        ...
        return request(path = "/api/secrets/${UrlEncoding.pathSegment(secretId)}/rotate", method = "POST", requestBody = payload).toSecretResponse()
    }

    @Throws(IOException::class)
    fun deleteSecret(secretId: String) {
        request(path = "/api/secrets/${UrlEncoding.pathSegment(secretId)}", method = "DELETE")
    }
    ...
    fun createBuild(projectId: String, buildRequest: BuildRequest = BuildRequest()): BuildSummary {
        val payload = JSONObject()
            ...
            .toString()
        return request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/builds", method = "POST", requestBody = payload).toBuildSummary()
    }

    @Throws(IOException::class)
    fun listBuilds(projectId: String): List<BuildSummary> {
        val body = request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/builds", method = "GET")
    ...
    fun getBuild(projectId: String, buildId: String): BuildSummary =
        request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/builds/${UrlEncoding.pathSegment(buildId)}", method = "GET").toBuildSummary()

    @Throws(IOException::class)
    fun getBuildLogs(projectId: String, buildId: String): String {
        val body = request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/builds/${UrlEncoding.pathSegment(buildId)}/logs", method = "GET")
    ...
    fun getProjectRuntimeStatus(projectId: String): RuntimeStatusResponse =
        request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/runtime/status", method = "GET").toRuntimeStatusResponse()

    @Throws(IOException::class)
    fun runtimeAction(projectId: String, action: String): RuntimeStatusResponse =
        request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/runtime/$action", method = "POST", requestBody = "{}").toRuntimeStatusResponse()

    @Throws(IOException::class)
    fun getProjectRuntimeLogs(projectId: String): String {
        val body = request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/runtime/logs", method = "GET")
        return body.asJsonOrNull()?.optionalString("logs") ?: body
    }
    ...
    fun testDeploymentTarget(targetId: String): DeploymentTargetTestResponse =
        request(path = "/api/deployment-targets/${UrlEncoding.pathSegment(targetId)}/test", method = "POST", requestBody = "{}").toDeploymentTargetTestResponse()
    ...
    fun createDeployment(projectId: String, request: DeploymentCreateRequest): DeploymentJobSummary {
        ...
        return this.request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/deployments", method = "POST", requestBody = payload).toDeploymentJobSummary()
    }

    @Throws(IOException::class)
    fun listDeployments(projectId: String): List<DeploymentJobSummary> {
        val body = request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/deployments", method = "GET")
    ...
    fun getDeploymentLogs(projectId: String, deploymentId: String): String {
        val body = request(path = "/api/projects/${UrlEncoding.pathSegment(projectId)}/deployments/${UrlEncoding.pathSegment(deploymentId)}/logs", method = "GET")
        return body.asJsonOrNull()?.optionalString("logs") ?: body
    }
